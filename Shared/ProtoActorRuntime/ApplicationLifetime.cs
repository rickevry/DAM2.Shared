...
namespace DAM2.Shared.ProtoActorRuntime
{
    ...
    internal sealed class ProtoClientApplicationLifetime : ApplicationLifetime
    {
        public ProtoClientApplicationLifetime(ILogger<ApplicationLifetime> logger) : base(logger)
        {
        }
    }

    internal sealed class ProtoClusterApplicationLifetime : ApplicationLifetime
    {
        public ProtoClusterApplicationLifetime(ILogger<ApplicationLifetime> logger) : base(logger)
        {
        }
    }
}
